...
def with_list():
	...
	while True:
		...
		req=post(f'https://accounts.snapchat.com/accounts/get_username_suggestions',headers={'accept': '*/*','accept-encoding': 'gzip, deflate, br','accept-language': 'en-US,en;q=0.9','content-length': '57',
